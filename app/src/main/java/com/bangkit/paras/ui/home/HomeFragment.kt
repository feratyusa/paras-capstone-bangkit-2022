...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val skinTipsFragment = mFragmentManager.findFragmentByTag(SkincareTipsFragment::class.java.simpleName)
        if (skinTipsFragment !is SkincareTipsFragment) {
            mFragmentManager
                .beginTransaction()
                .add(R.id.flSkincareTipsFragment, mSkincareTips, SkincareTipsFragment::class.java.simpleName)
                .commit()
        }

        val mScanFace = ScanFaceFragment()
        val scanFaceFragment = mFragmentManager.findFragmentByTag(ScanFaceFragment::class.java.simpleName)
