...
class DetailTipsAdapter(private val listTips:  List<TipsItem>):  RecyclerView.Adapter<DetailTipsAdapter.ListViewHolder>() {

    class ListViewHolder(var binding: SkincareTipsDetailCardBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val binding = SkincareTipsDetailCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
