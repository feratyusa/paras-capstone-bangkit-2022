...
class SkincareTipsAdapter(private val listTips: List<SkincareTipsItem>) :
    RecyclerView.Adapter<SkincareTipsAdapter.ListViewHolder>() {
    ...
    class ListViewHolder(var binding: SkincareTipsCardBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val binding =
            SkincareTipsCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
